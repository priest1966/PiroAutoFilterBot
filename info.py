...
# Bot images & videos
PICS = (environ.get('PICS', 'https://graph.org/file/bdf74912ff48bcedbe9cc.jpg')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', "movieverse_discussion")
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", '<b>{query} {year}</b>\n\n\n\n<b>DOWNLOAD {query} From Here</b>\n\n<>b/Join Backup Channel:</b> [MovieVerse Backup](https://t.me/movieversepremium)')
